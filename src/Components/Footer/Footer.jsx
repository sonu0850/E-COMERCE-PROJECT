...
const Footer = () => {
  return (
    <>
      <footer className="relative flex justify-center items-center text-white z-10 bg-[#222E3A] pb-[25px] pt-20 dark:bg-dark ]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <LinkGroup header=" Disclaimer">


             
              
            </LinkGroup>
            <LinkGroup header="Privacy Policy">
 
              
            </LinkGroup>
            <LinkGroup  header="Terms & Conditions  ">
         
              
            </LinkGroup>
            <LinkGroup header="Feedback">
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-body-color ms-3 hover:text-primary dark:text-dark-6"
      >
        {label}
      </a>
    </li>
