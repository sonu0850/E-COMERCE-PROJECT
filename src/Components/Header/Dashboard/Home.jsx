...
/>
      <div className="px-6 py-4">
        <div className="font-bold text-sm mb-2">{item.title.slice(0,15)}...</div>
      ...
      <div className="px-6 pt-4 pb-2">
        ...
        <span className="inline-block bg-blue-200 rounded-full px-3 py-1 text-sm font-semibold text-black mr-2 mb-2">
